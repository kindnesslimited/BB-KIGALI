...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, color: colors.onSurface, fontSize: 16, fontFamily: "Poppins-Regular" },
  ...
  googleText: { color: colors.onSurface, fontSize: 15, fontFamily: "Poppins-Regular", fontWeight: "500" },
  ...
  appleText: { color: "#fff", fontSize: 15, fontFamily: "Poppins-Regular", fontWeight: "600" },
